...
abstract class _$$AuthStateAuthenticatedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String accessToken, String refreshToken, String userId, String email});
}
...
class _$AuthStateAuthenticatedImpl implements AuthStateAuthenticated {
  ...
  @override
  String toString() {
    return 'AuthState.authenticated(accessToken: $accessToken, refreshToken: $refreshToken, userId: $userId, email: $email)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, accessToken, refreshToken, userId, email);
  ...
  TResult when<TResult extends Object?>({
    ...
    return authenticated(accessToken, refreshToken, userId, email);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return authenticated?.call(accessToken, refreshToken, userId, email);
  }
...
abstract class AuthStateAuthenticated implements AuthState {
  const factory AuthStateAuthenticated(
      ...
      required final String email}) = _$AuthStateAuthenticatedImpl;
